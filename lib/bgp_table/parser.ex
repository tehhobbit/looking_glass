defmodule BgpTable.Parser do
  ...
  def delete_path([], _path), do: :nomatch
  def delete_path([{_prefix, result}], path), do: delete_path(result, path, [])
  def delete_path([], _path, []), do: :empty
  def delete_path([], _path, acc), do: acc
